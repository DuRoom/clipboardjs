...
export function getTheme(theme_name) {
    ...
    switch (theme_name) {
        case 'github':
            ...
            break;
        case 'lingcoder':
            btnChild = '<span class="label">'+app.translator.trans('duroom-clipboardjs.forum.action_copy')+'</span>';
            btnChildT = '<span class="success">'+app.translator.trans('duroom-clipboardjs.forum.ok_btn')+'</span>';
            btnChildF = '<span class="error">'+app.translator.trans('duroom-clipboardjs.forum.error_btn')+'</span>';
            break;
        case 'csdn':
            btnChild = '<span class="label">'+app.translator.trans('duroom-clipboardjs.forum.action_copy')+'</span>';
            btnChildT = '<span class="success">'+app.translator.trans('duroom-clipboardjs.forum.ok_btn')+'</span>';
