...
app.initializers.add('duroom/clipboardjs', () => {
    ...
    function getTrans(key) {
        return app.translator.trans('duroom-clipboardjs.forum.' + key);
    }
    ...
    function fallbackMessage(action) {
        ...
        if (/iPhone|iPad/i.test(navigator.userAgent)) {
            ...
            actionMsg = app.translator.trans('duroom-clipboardjs.forum.msg', {
                actionKey: '⌘-' + actionKey,
                action: action,
            });
        } else {
